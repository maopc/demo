...
Page({
  ...
  data: {
    ...
    sliderList: [
      ...
      { selected: false, imageSource: '../../images/2.jpg' }, { selected: false, imageSource: '../../images/2.jpg' }, { selected: false, imageSource: '../../images/2.jpg' },
  ...
  onShow: function (options) {
    ...
    if (app.globalData.changeCity=='1'){
      that.setData({
  ...
  getLocation: function () {
    ...
    wx.getLocation({
      ...
      success: function (res) {
        ...
        wx.request({
          url: 'https://api.map.baidu.com/geocoder/v2/?location=' + res.latitude + ',' + res.longitude + '&output=json&pois=1&ak=ejETveLAb0di8B4kLIq8lMcIT24GvPnQ',
          success: res => {
